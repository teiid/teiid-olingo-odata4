...
public class EdmReferenceIncludeAnnotationsImpl implements
		EdmReferenceIncludeAnnotations {

	private String termNamespace;
	private String qualifer;
	private String targetNamespace;
	
	public EdmReferenceIncludeAnnotationsImpl(String termNS, String qualifier, String targetNS) {
